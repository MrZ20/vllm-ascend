...
def test_gpt_oss_other_loader_remaps_routed_expert_weight_names(monkeypatch):
    ...
    monkeypatch.setattr(
        GptOssModel,
        "_ascend_original_load_weights_other",
        fake_original_load_weights_other,
    )
...
def test_gpt_oss_other_loader_does_not_double_remap_routed_names():
    ...
    from vllm_ascend.patch.worker.patch_gpt_oss import (
        _remap_gpt_oss_routed_expert_weight_names,
    )
