...
CONFIG_BASE_PATH = os.getenv("CONFIG_BASE_PATH") or "tests/e2e/schedule/model"
...
class SingleNodeConfigLoader:
    ...
    DEFAULT_CONFIG_NAME = "Kimi/one_node/Kimi-K2-Thinking.yaml"
    ...
    def _load_yaml(cls, yaml_path: str | None) -> dict[str, Any]:
        ...
        if os.path.isabs(yaml_path) or os.path.exists(yaml_path):
            full_path = yaml_path
        else:
