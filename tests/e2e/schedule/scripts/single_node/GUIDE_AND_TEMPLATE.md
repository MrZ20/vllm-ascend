...
* `tests/e2e/schedule/scripts/single_node/single_node_config.py`
    ...
    * Loads YAML from `tests/e2e/schedule/model/<Family>/<resource_dir>/<CONFIG_YAML_PATH>`
...
export CONFIG_YAML_PATH="tests/e2e/schedule/model/Qwen/four_card/Qwen3-32B-Int8.yaml"
...
* YAML files live under: `tests/e2e/schedule/model/`
